...
$packages["vueutil"] = (function() {
	var $pkg = {}, $init, js, vue, PropsData, GetTemplateById, EmptyDataFunc, AddWatch, AddMounted, AddDestroyed;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	...
	AddWatch = function(o, name, fn) {
		var fn, name, o, obj, watch;
		obj = new ($global.Object)();
		obj.handler = js.MakeFunc((function $b(this$1, arguments$1) {
			var arguments$1, this$1, vm, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; arguments$1 = $f.arguments$1; this$1 = $f.this$1; vm = $f.vm; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			vm = new vue.ViewModel.ptr(this$1, null, null, null, null, null, null, null, null, false, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError);
			$r = fn(vm, (0 >= arguments$1.$length ? ($throwRuntimeError("index out of range"), undefined) : arguments$1.$array[arguments$1.$offset + 0]), (1 >= arguments$1.$length ? ($throwRuntimeError("index out of range"), undefined) : arguments$1.$array[arguments$1.$offset + 1])); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			$s = -1; return $ifaceNil;
			/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.arguments$1 = arguments$1; $f.this$1 = this$1; $f.vm = vm; $f.$s = $s; $f.$r = $r; return $f;
		}));
		obj.deep = $externalize(false, $Bool);
		watch = new ($global.Object)();
		watch[$externalize(name, $String)] = obj;
		return o.Mixin($makeMap($String.keyFor, [{ k: "watch", v: new $jsObjectPtr(watch) }]));
	};
	$pkg.AddWatch = AddWatch;
	AddMounted = function(o, fn) {
		var fn, mounted, o;
		mounted = js.MakeFunc((function $b(this$1, arguments$1) {
			var arguments$1, this$1, vm, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; arguments$1 = $f.arguments$1; this$1 = $f.this$1; vm = $f.vm; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			vm = new vue.ViewModel.ptr(this$1, null, null, null, null, null, null, null, null, false, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError);
			$r = fn(vm); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		...
		return o.Mixin($makeMap($String.keyFor, [{ k: "mounted", v: new $jsObjectPtr(mounted) }]));
	};
	$pkg.AddMounted = AddMounted;
	AddDestroyed = function(o, fn) {
		var destroyed, fn, o;
		destroyed = js.MakeFunc((function $b(this$1, arguments$1) {
			var arguments$1, this$1, vm, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; arguments$1 = $f.arguments$1; this$1 = $f.this$1; vm = $f.vm; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			vm = new vue.ViewModel.ptr(this$1, null, null, null, null, null, null, null, null, false, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError, $throwNilPointerError);
			$r = fn(vm); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		...
		return o.Mixin($makeMap($String.keyFor, [{ k: "destroyed", v: new $jsObjectPtr(destroyed) }]));
	};
	$pkg.AddDestroyed = AddDestroyed;
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$packages["examples/wrapper"] = (function() {
	var $pkg = {}, $init, js, json, vue, vueutil, Select2Data, Select2Props, Select2, Option, ptrType, sliceType, ptrType$1, ptrType$2, sliceType$1, funcType, funcType$1, ptrType$3, NewAppData, main, NewSelect2, InitSelect2, NewOption;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	json = $packages["vendor/github.com/oskca/gopherjs-json"];
	vue = $packages["vendor/github.com/oskca/gopherjs-vue"];
	vueutil = $packages["vueutil"];
	Select2Data = $pkg.Select2Data = $newType(0, $kindStruct, "main.Select2Data", true, "examples/wrapper", true, function(Object_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			return;
	...
	Select2Props = $pkg.Select2Props = $newType(0, $kindStruct, "main.Select2Props", true, "examples/wrapper", true, function(Object_, Options_, Value_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Options = sliceType.nil;
			this.Value = 0;
			return;
		}
		this.Object = Object_;
	...
	Select2 = $pkg.Select2 = $newType(0, $kindStruct, "main.Select2", true, "examples/wrapper", true, function(Data_, Props_) {
		this.$val = this;
		if (arguments.length === 0) {
	...
	Option = $pkg.Option = $newType(0, $kindStruct, "main.Option", true, "examples/wrapper", true, function(Object_, Id_, Text_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Id = 0;
	...
	ptrType = $ptrType(Option);
	sliceType = $sliceType(ptrType);
	ptrType$1 = $ptrType(Select2Data);
	ptrType$2 = $ptrType(Select2Props);
	sliceType$1 = $sliceType($String);
	funcType = $funcType([], [$emptyInterface], false);
	funcType$1 = $funcType([], [], false);
	ptrType$3 = $ptrType(js.Object);
	NewAppData = function() {
		var obj, options;
		options = new sliceType([NewOption(1, "Hello"), NewOption(2, "World")]);
		obj = new ($global.Object)();
		obj.selected = 2;
		obj.options = $externalize(options, sliceType);
		return new $jsObjectPtr(obj);
	};
	$pkg.NewAppData = NewAppData;
	main = function() {
		var o, v, $s, $r;
		...
		InitSelect2();
		o = vue.NewOption();
		o.Object.template = $externalize(vueutil.GetTemplateById("demo-template"), $String);
		o.Object.data = $externalize(NewAppData(), $emptyInterface);
		v = o.NewViewModel();
		v.Object.$mount($externalize("#el", $String));
		$s = -1; return;
		/* */ } return; } if ($f === undefined) { $f = { $blk: main }; } $f.o = o; $f.v = v; $f.$s = $s; $f.$r = $r; return $f;
	};
	NewSelect2 = function(vm) {
		var vm;
		return new Select2.ptr(new Select2Data.ptr(vm.Object.$data), new Select2Props.ptr(vueutil.PropsData(vm), sliceType.nil, 0));
	};
	$pkg.NewSelect2 = NewSelect2;
	InitSelect2 = function() {
		var o;
		o = vue.NewOption();
		o.Object.name = $externalize("select2", $String);
		o.Object.template = $externalize(vueutil.GetTemplateById("select2-template"), $String);
		o.AddProp(new sliceType$1(["options", "value"]));
		o.Object.data = $externalize(new funcType(vueutil.EmptyDataFunc), $emptyInterface);
		o = vueutil.AddWatch(o, "value", (function(vm, newVal, oldVal) {
			var newVal, oldVal, sel, vm;
			console.log("update value", json.Stringify(new $jsObjectPtr(newVal)), json.Stringify(new $jsObjectPtr(oldVal)));
			sel = NewSelect2(vm);
			new ($pkg.JQuery)(vm.Object.$el).val($parseInt(sel.Props.Object.value) >> 0).trigger($externalize("change", $String));
		}));
		o = vueutil.AddWatch(o, "options", (function(vm, newVal, oldVal) {
			var arg, newVal, oldVal, sel, vm;
			console.log("update options", json.Stringify(new $jsObjectPtr(newVal)), json.Stringify(new $jsObjectPtr(oldVal)));
			sel = NewSelect2(vm);
			arg = new ($global.Object)();
			arg.data = $externalize($internalize(sel.Props.Object.options, sliceType), sliceType);
			new ($pkg.JQuery)(vm.Object.$el).select2(arg);
		}));
		o = vueutil.AddMounted(o, (function(vm) {
			var argA, objA, objB, objC, objD, sel, vm;
			console.log("Mounted Call", vm.Object.$el);
			sel = NewSelect2(vm);
			console.log("on Mounted", $parseInt(sel.Props.Object.value) >> 0);
			objA = new ($pkg.JQuery)(vm.Object.$el);
			argA = new ($global.Object)();
			argA.data = $externalize($internalize(sel.Props.Object.options, sliceType), sliceType);
			objB = objA.select2(argA);
			objC = objB.val($parseInt(sel.Props.Object.value) >> 0);
			objD = objC.trigger($externalize("change", $String));
			objD.on($externalize("change", $String), $externalize((function $b() {
				var value, $s, $r;
				/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; value = $f.value; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
				console.log("on trigger change", new ($pkg.JQuery)(vm.Object.$el)[0].value);
				value = $parseInt(new ($pkg.JQuery)(vm.Object.$el)[0].value) >> 0;
				vm.Object.$emit($externalize("input", $String), value);
				$s = -1; return;
				/* */ } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.value = value; $f.$s = $s; $f.$r = $r; return $f;
			}), funcType$1));
		}));
		o = vueutil.AddDestroyed(o, (function(vm) {
			var vm;
			console.log("Destroyed Call", vm.Object.$el);
			new ($pkg.JQuery)(vm.Object.$el).off().select2($externalize("destroy", $String));
		}));
		o.NewComponent().Register("select2");
	};
	$pkg.InitSelect2 = InitSelect2;
	NewOption = function(id, text) {
		var id, opt, text;
		opt = new Option.ptr(new ($global.Object)(), 0, "");
		opt.Object.id = id;
		opt.Object.text = $externalize(text, $String);
		return opt;
	};
	$pkg.NewOption = NewOption;
	Select2Data.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$3, tag: ""}]);
	Select2Props.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$3, tag: ""}, {prop: "Options", name: "Options", anonymous: false, exported: true, typ: sliceType, tag: "js:\"options\""}, {prop: "Value", name: "Value", anonymous: false, exported: true, typ: $Int, tag: "js:\"value\""}]);
	Select2.init("", [{prop: "Data", name: "Data", anonymous: false, exported: true, typ: ptrType$1, tag: ""}, {prop: "Props", name: "Props", anonymous: false, exported: true, typ: ptrType$2, tag: ""}]);
	Option.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$3, tag: ""}, {prop: "Id", name: "Id", anonymous: false, exported: true, typ: $Int, tag: "js:\"id\""}, {prop: "Text", name: "Text", anonymous: false, exported: true, typ: $String, tag: "js:\"text\""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$synthesizeMethods();
var $mainPkg = $packages["examples/wrapper"];
