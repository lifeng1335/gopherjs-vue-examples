...
$packages["examples/markdown"] = (function() {
	var $pkg = {}, $init, js, vue, vueutil, AppData, AppProps, App, ptrType, ptrType$1, funcType, ptrType$2, ptrType$3, funcType$1, sliceType, ptrType$4, NewApp, main, NewAppData;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	vue = $packages["vendor/github.com/oskca/gopherjs-vue"];
	vueutil = $packages["vueutil"];
	AppData = $pkg.AppData = $newType(0, $kindStruct, "main.AppData", true, "examples/markdown", true, function(Object_, Input_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Input = "";
	...
	AppProps = $pkg.AppProps = $newType(0, $kindStruct, "main.AppProps", true, "examples/markdown", true, function(Object_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			return;
	...
	App = $pkg.App = $newType(0, $kindStruct, "main.App", true, "examples/markdown", true, function(Date_, Props_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Date = ptrType.nil;
	...
	ptrType = $ptrType(AppData);
	ptrType$1 = $ptrType(AppProps);
	funcType = $funcType([], [$emptyInterface], false);
	ptrType$2 = $ptrType(vue.ViewModel);
	ptrType$3 = $ptrType(js.Object);
	funcType$1 = $funcType([ptrType$2, ptrType$3], [], false);
	sliceType = $sliceType(funcType$1);
	ptrType$4 = $ptrType(App);
	NewApp = function(vm) {
		var vm;
		return new App.ptr(new AppData.ptr(vm.Object.$data, ""), new AppProps.ptr(vueutil.PropsData(vm)));
	};
	$pkg.NewApp = NewApp;
	App.ptr.prototype.SyncViewModel = function(vm) {
		var _i, _ref, app, keys, v, vm;
		app = this;
		...
		while (true) {
			...
			vm.Object.$data[$externalize(v, $String)] = app.Date.Object[$externalize(v, $String)];
			_i++;
		}
		vm.Object.$options.propsData = app.Props.Object;
	};
	App.prototype.SyncViewModel = function(vm) { return this.$val.SyncViewModel(vm); };
	main = function() {
		var o, v, $s, $r;
		...
		o = vue.NewOption();
		o.Object.data = $externalize(new funcType(NewAppData), $emptyInterface);
		o.AddMethod("Update", (function(vm, args) {
			var app, args, vm;
			app = NewApp(vm);
			app.Update((0 >= args.$length ? ($throwRuntimeError("index out of range"), undefined) : args.$array[args.$offset + 0]));
			app.SyncViewModel(vm);
		}));
		o.AddComputed("compiledMarkdown", (function(vm) {
			var app, vm;
			app = NewApp(vm);
			return new $jsObjectPtr(app.CompiledMarkdown());
		}), new sliceType([]));
		v = o.NewViewModel();
		v.Object.$mount($externalize("#editor", $String));
		$s = -1; return;
		/* */ } return; } if ($f === undefined) { $f = { $blk: main }; } $f.o = o; $f.v = v; $f.$s = $s; $f.$r = $r; return $f;
	};
	NewAppData = function() {
		var ad;
		ad = new AppData.ptr(new ($global.Object)(), "");
		ad.Object.input = $externalize("# hello", $String);
		return ad;
	};
	$pkg.NewAppData = NewAppData;
	App.ptr.prototype.Update = function(event) {
		var app, event;
		app = this;
		app.Date.Object.input = $externalize($internalize(event.target.value, $String), $String);
	};
	App.prototype.Update = function(event) { return this.$val.Update(event); };
	App.ptr.prototype.CompiledMarkdown = function() {
		var app;
		app = this;
		return $global.marked($externalize($internalize(app.Date.Object.input, $String), $String), $externalize("{ sanitize: true }", $String));
	};
	App.prototype.CompiledMarkdown = function() { return this.$val.CompiledMarkdown(); };
	ptrType$4.methods = [{prop: "SyncViewModel", name: "SyncViewModel", pkg: "", typ: $funcType([ptrType$2], [], false)}, {prop: "Update", name: "Update", pkg: "", typ: $funcType([ptrType$3], [], false)}, {prop: "CompiledMarkdown", name: "CompiledMarkdown", pkg: "", typ: $funcType([], [ptrType$3], false)}];
	AppData.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$3, tag: ""}, {prop: "Input", name: "Input", anonymous: false, exported: true, typ: $String, tag: "js:\"input\""}]);
	AppProps.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$3, tag: ""}]);
	App.init("", [{prop: "Date", name: "Date", anonymous: false, exported: true, typ: ptrType, tag: ""}, {prop: "Props", name: "Props", anonymous: false, exported: true, typ: ptrType$1, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$synthesizeMethods();
var $mainPkg = $packages["examples/markdown"];
