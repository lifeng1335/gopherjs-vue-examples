...
$packages["vueutil"] = (function() {
	var $pkg = {}, $init, js, vue, PropsData, GetTemplateById;
	js = $packages["github.com/gopherjs/gopherjs/js"];
...
$packages["examples/tree"] = (function() {
	var $pkg = {}, $init, js, vue, vueutil, Node, TreeData, TreeProps, Tree, ptrType, sliceType, ptrType$1, ptrType$2, sliceType$1, funcType, ptrType$3, ptrType$4, funcType$1, sliceType$2, ptrType$5, NewNode, NewAppData, main, NewTree, NewTreeData, InitTree;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	vue = $packages["vendor/github.com/oskca/gopherjs-vue"];
	vueutil = $packages["vueutil"];
	Node = $pkg.Node = $newType(0, $kindStruct, "main.Node", true, "examples/tree", true, function(Object_, Name_, Children_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Name = "";
	...
	TreeData = $pkg.TreeData = $newType(0, $kindStruct, "main.TreeData", true, "examples/tree", true, function(Object_, Open_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Open = false;
	...
	TreeProps = $pkg.TreeProps = $newType(0, $kindStruct, "main.TreeProps", true, "examples/tree", true, function(Object_, Model_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Model = ptrType.nil;
			return;
		}
		this.Object = Object_;
		this.Model = Model_;
	});
	Tree = $pkg.Tree = $newType(0, $kindStruct, "main.Tree", true, "examples/tree", true, function(Data_, Props_) {
		this.$val = this;
		if (arguments.length === 0) {
	...
	sliceType = $sliceType(ptrType);
	ptrType$1 = $ptrType(TreeData);
	ptrType$2 = $ptrType(TreeProps);
	sliceType$1 = $sliceType($String);
	funcType = $funcType([], [$emptyInterface], false);
	...
	ptrType$5 = $ptrType(Tree);
	NewNode = function(Name, Children) {
		var Children, Name, d;
		d = new Node.ptr(new ($global.Object)(), "", sliceType.nil);
		d.Object.name = $externalize(Name, $String);
		d.Object.children = $externalize(Children, sliceType);
		return d;
	};
	$pkg.NewNode = NewNode;
	NewAppData = function() {
		var m, obj;
		obj = new ($global.Object)();
		m = NewNode("My Tree", new sliceType([NewNode("hello", sliceType.nil), NewNode("wat", sliceType.nil), NewNode("child folder", new sliceType([NewNode("child folder", new sliceType([NewNode("hello", sliceType.nil), NewNode("wat", sliceType.nil)])), NewNode("hello", sliceType.nil), NewNode("wat", sliceType.nil), NewNode("child folder", new sliceType([NewNode("hello", sliceType.nil), NewNode("wat", sliceType.nil)]))]))]));
		obj.treeData = $externalize(m, ptrType);
		return obj;
	};
	...
	main = function() {
		...
		InitTree();
		o = vue.NewOption();
		o.Object.data = $externalize(new $jsObjectPtr(NewAppData()), $emptyInterface);
		v = o.NewViewModel();
	...
	NewTree = function(vm) {
		var vm;
		return new Tree.ptr(new TreeData.ptr(vm.Object.$data, false), new TreeProps.ptr(vueutil.PropsData(vm), ptrType.nil));
	};
	$pkg.NewTree = NewTree;
	NewTreeData = function() {
		var g;
		g = new TreeData.ptr(new ($global.Object)(), false);
		g.Object.open = $externalize(false, $Bool);
		return g;
	};
	$pkg.NewTreeData = NewTreeData;
	Tree.ptr.prototype.SyncViewModel = function(vm) {
		var _i, _ref, keys, t, v, vm;
		t = this;
		...
		while (true) {
			...
			vm.Object.$data[$externalize(v, $String)] = t.Data.Object[$externalize(v, $String)];
			_i++;
		}
		vm.Object.$options.propsData = t.Props.Object;
	};
	Tree.prototype.SyncViewModel = function(vm) { return this.$val.SyncViewModel(vm); };
	Tree.ptr.prototype.IsFolder = function() {
		var t;
		t = this;
		if (!(($internalize($internalize(t.Props.Object.model, ptrType).Object.children, sliceType).$length === 0))) {
			return true;
		}
		return false;
	};
	Tree.prototype.IsFolder = function() { return this.$val.IsFolder(); };
	Tree.ptr.prototype.AddChild = function() {
		var t;
		t = this;
		$internalize(t.Props.Object.model, ptrType).Object.children = $externalize($append($internalize($internalize(t.Props.Object.model, ptrType).Object.children, sliceType), NewNode("new stuff", sliceType.nil)), sliceType);
	};
	Tree.prototype.AddChild = function() { return this.$val.AddChild(); };
	Tree.ptr.prototype.ChangeType = function() {
		var t;
		t = this;
		if (!t.IsFolder()) {
			t.Data.Object.open = $externalize(true, $Bool);
			t.AddChild();
		}
	};
	Tree.prototype.ChangeType = function() { return this.$val.ChangeType(); };
	Tree.ptr.prototype.Toggle = function() {
		var t;
		t = this;
		if (t.IsFolder()) {
			t.Data.Object.open = $externalize(!!!(t.Data.Object.open), $Bool);
		}
	};
	Tree.prototype.Toggle = function() { return this.$val.Toggle(); };
	InitTree = function() {
		var o;
		o = vue.NewOption();
		o.Object.name = $externalize("item", $String);
		o.Object.template = $externalize(vueutil.GetTemplateById("item-template"), $String);
		o.AddProp(new sliceType$1(["model"]));
		o.Object.data = $externalize(new funcType(NewTreeData), $emptyInterface);
		o.AddMethod("Toggle", (function(vm, args) {
			var args, tree, vm;
			tree = NewTree(vm);
			tree.Toggle();
			tree.SyncViewModel(vm);
		}));
		o.AddMethod("AddChild", (function(vm, args) {
			var args, tree, vm;
			tree = NewTree(vm);
			tree.AddChild();
			tree.SyncViewModel(vm);
		}));
		o.AddMethod("ChangeType", (function(vm, args) {
			var args, tree, vm;
			tree = NewTree(vm);
			tree.ChangeType();
			tree.SyncViewModel(vm);
		}));
		o.AddComputed("isFolder", (function(vm) {
			var tree, vm;
			tree = NewTree(vm);
			return new $Bool(tree.IsFolder());
		}), new sliceType$2([]));
		o.NewComponent().Register("item");
	};
	$pkg.InitTree = InitTree;
	ptrType$5.methods = [{prop: "SyncViewModel", name: "SyncViewModel", pkg: "", typ: $funcType([ptrType$3], [], false)}, {prop: "IsFolder", name: "IsFolder", pkg: "", typ: $funcType([], [$Bool], false)}, {prop: "AddChild", name: "AddChild", pkg: "", typ: $funcType([], [], false)}, {prop: "ChangeType", name: "ChangeType", pkg: "", typ: $funcType([], [], false)}, {prop: "Toggle", name: "Toggle", pkg: "", typ: $funcType([], [], false)}];
	Node.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$4, tag: ""}, {prop: "Name", name: "Name", anonymous: false, exported: true, typ: $String, tag: "js:\"name\""}, {prop: "Children", name: "Children", anonymous: false, exported: true, typ: sliceType, tag: "js:\"children\""}]);
	TreeData.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$4, tag: ""}, {prop: "Open", name: "Open", anonymous: false, exported: true, typ: $Bool, tag: "js:\"open\""}]);
	TreeProps.init("", [{prop: "Object", name: "Object", anonymous: true, exported: true, typ: ptrType$4, tag: ""}, {prop: "Model", name: "Model", anonymous: false, exported: true, typ: ptrType, tag: "js:\"model\""}]);
	Tree.init("", [{prop: "Data", name: "Data", anonymous: false, exported: true, typ: ptrType$1, tag: ""}, {prop: "Props", name: "Props", anonymous: false, exported: true, typ: ptrType$2, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		$r = vue.$init(); /* */ $s = 2; case 2: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
		$r = vueutil.$init(); /* */ $s = 3; case 3: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$synthesizeMethods();
var $mainPkg = $packages["examples/tree"];
