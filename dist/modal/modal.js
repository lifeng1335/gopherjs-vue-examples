...
$packages["vueutil"] = (function() {
	var $pkg = {}, $init, js, vue, GetTemplateById;
	js = $packages["github.com/gopherjs/gopherjs/js"];
...
$packages["examples/modal"] = (function() {
	var $pkg = {}, $init, js, vue, vueutil, NewAppData, main, InitModal;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	vue = $packages["vendor/github.com/oskca/gopherjs-vue"];
	...
	NewAppData = function() {
		var obj;
		obj = new ($global.Object)();
		obj.showModal = $externalize(false, $Bool);
	...
	InitModal = function() {
		var o;
		o = vue.NewOption();
		o.Object.name = $externalize("modal", $String);
		o.Object.template = $externalize(vueutil.GetTemplateById("modal-template"), $String);
		o.NewComponent().Register("modal");
	};
	$pkg.InitModal = InitModal;
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$synthesizeMethods();
var $mainPkg = $packages["examples/modal"];
